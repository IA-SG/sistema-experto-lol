export const answersStatic = ["Si", "No"];

export const firstQuestionsArray = [
  {
    id: 1,
    question: "¿Cuál es tu linea preferida o que has jugado anteriormente?",
    answers: ["Top", "Jungla", "Mid", "Adc", "Support"],
  },
  {
    id: 2,
